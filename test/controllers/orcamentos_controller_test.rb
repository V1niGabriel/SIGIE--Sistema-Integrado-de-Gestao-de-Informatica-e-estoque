...
class OrcamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orcamento" do
    assert_difference("Orcamento.count") do
      post orcamentos_url, params: { orcamento: { cliente_id: @orcamento.cliente_id, data_orcamento: @orcamento.data_orcamento, data_validade: @orcamento.data_validade, funcionario_id: @orcamento.funcionario_id } }
    end
  ...
  test "should update orcamento" do
    patch orcamento_url(@orcamento), params: { orcamento: { cliente_id: @orcamento.cliente_id, data_orcamento: @orcamento.data_orcamento, data_validade: @orcamento.data_validade, funcionario_id: @orcamento.funcionario_id } }
