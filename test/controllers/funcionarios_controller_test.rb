...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { cargo_id: @funcionario.cargo_id, cpf: @funcionario.cpf, data_admissao: @funcionario.data_admissao, email: @funcionario.email, nome: @funcionario.nome, senha_hash: @funcionario.senha_hash, telefone: @funcionario.telefone } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cargo_id: @funcionario.cargo_id, cpf: @funcionario.cpf, data_admissao: @funcionario.data_admissao, email: @funcionario.email, nome: @funcionario.nome, senha_hash: @funcionario.senha_hash, telefone: @funcionario.telefone } }
