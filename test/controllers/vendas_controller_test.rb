...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference("Venda.count") do
      post vendas_url, params: { venda: { cliente_id: @venda.cliente_id, data_venda: @venda.data_venda, funcionario_id: @venda.funcionario_id, status_pagamento: @venda.status_pagamento } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { cliente_id: @venda.cliente_id, data_venda: @venda.data_venda, funcionario_id: @venda.funcionario_id, status_pagamento: @venda.status_pagamento } }
