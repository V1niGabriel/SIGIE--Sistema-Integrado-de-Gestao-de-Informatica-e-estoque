...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference("Cargo.count") do
      post cargos_url, params: { cargo: { descricao: @cargo.descricao, salario_base: @cargo.salario_base, titulo: @cargo.titulo } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { descricao: @cargo.descricao, salario_base: @cargo.salario_base, titulo: @cargo.titulo } }
